...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public void addRepo(String repoName, String description, String userName, boolean fork,String repo_url,String owner_url) {
        ...
        contentValues.put("repo_url", repo_url);
        contentValues.put("owner_url", owner_url);
    ...
    public ArrayList show_all_Repos() {
        ...
        while (cu.isAfterLast() == false) {
            ...
            String repo_url = cu.getString(cu.getColumnIndex("repo_url"));
            String owner_url = cu.getString(cu.getColumnIndex("owner_url"));

            arr.add(new ListItem(repoName, description, userName, fork,repo_url,owner_url));
            cu.moveToNext();
        }
        return arr;
    }
